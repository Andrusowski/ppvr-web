...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/asaks/Dev/Projects/PPvR/ppvr-web/public/storage' => 'string',
            ...
            'ranking.scoreSumQuery' => 'string',
            'ranking.scoreAvgQuery' => 'string',
            'scribe.title' => 'string',
            ...
            'scribe.routes.0.apply.headers.Content-Type' => 'string',
            'scribe.routes.0.apply.headers.Accept' => 'string',
            'scribe.routes.0.apply.response_calls.methods' => 'array',
            'scribe.routes.0.apply.response_calls.config.app.env' => 'string',
            'scribe.routes.0.apply.response_calls.queryParams' => 'array',
            'scribe.routes.0.apply.response_calls.bodyParams' => 'array',
            'scribe.routes.0.apply.response_calls.fileParams' => 'array',
            'scribe.routes.0.apply.response_calls.cookies' => 'array',
            'scribe.type' => 'string',
            'scribe.theme' => 'string',
            ...
            'scribe.default_group' => 'string',
            'scribe.faker_seed' => 'NULL',
            ...
            'services.osu.client_id' => 'string',
            'services.osu.client_secret' => 'string',
            'services.osu.redirect' => 'string',
...
'app.aliases.URL','app.aliases.Validator','app.aliases.View','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.secret','filesystems.disks.s3.region','filesystems.disks.s3.bucket','filesystems.disks.s3.url','filesystems.links./home/asaks/Dev/Projects/PPvR/ppvr-web/public/storage',
'filesystems.cloud','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory','hashing.argon.threads',
'hashing.argon.time','hashing.rehash_on_login','logging.default','logging.deprecations.channel','logging.deprecations.trace',
'logging.channels.stack.driver','logging.channels.stack.channels','logging.channels.single.driver','logging.channels.single.path','logging.channels.single.level',
...
'logging.channels.papertrail.processors','logging.channels.stderr.driver','logging.channels.stderr.handler','logging.channels.stderr.with.stream','logging.channels.syslog.driver',
...
'logging.channels.emergency.path','logging.channels.sentry.driver','logging.channels.sentry_logs.driver','logging.channels.sentry_logs.level','mail.default',
...
'mail.encryption','mail.username','mail.password','mail.sendmail','motd.message',
'motd.type','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.table',
'queue.connections.database.queue','queue.connections.database.retry_after','queue.connections.beanstalkd.driver','queue.connections.beanstalkd.host','queue.connections.beanstalkd.queue',
'queue.connections.beanstalkd.retry_after','queue.connections.sqs.driver','queue.connections.sqs.key','queue.connections.sqs.secret','queue.connections.sqs.prefix',
...
'queue.batching.database','queue.batching.table','queue.failed.database','queue.failed.table','ranking.scoreSumQuery',
'ranking.scoreAvgQuery','scribe.title','scribe.description','scribe.intro_text','scribe.base_url',
'scribe.routes.0.match.prefixes','scribe.routes.0.match.domains','scribe.routes.0.match.versions','scribe.routes.0.include','scribe.routes.0.exclude',
'scribe.routes.0.apply.headers.Content-Type','scribe.routes.0.apply.headers.Accept','scribe.routes.0.apply.response_calls.methods','scribe.routes.0.apply.response_calls.config.app.env','scribe.routes.0.apply.response_calls.queryParams',
'scribe.routes.0.apply.response_calls.bodyParams','scribe.routes.0.apply.response_calls.fileParams','scribe.routes.0.apply.response_calls.cookies','scribe.type','scribe.theme',
'scribe.static.output_path','scribe.laravel.add_routes','scribe.laravel.docs_url','scribe.laravel.middleware','scribe.external.html_attributes',
...
'scribe.strategies.headers','scribe.strategies.bodyParameters','scribe.strategies.responses','scribe.strategies.responseFields','scribe.database_connections_to_transact',
'scribe.fractal.serializer','scribe.default_group','scribe.faker_seed','scribe.routeMatcher','sentry.dsn',
...
'services.sparkpost.secret','services.stripe.model','services.stripe.key','services.stripe.secret','services.osu.client_id',
'services.osu.client_secret','services.osu.redirect','session.driver','session.lifetime','session.expire_on_close',
...
'ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','api/players','api/player-by-id',
'api/posts','api/post-by-id','api/posts-by-player','api/ranks-by-player','profile.player','auth.osu',
'auth.osu.callback','logout','auth.me','game.stats.sync','game.stats.get',
'game.stats.initial-sync',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.email','auth.passwords.reset','auth.register','content.changelog',
'content.faq','content.stats','game.index','highlight.highlights','index',
'layouts.main','legal.notice','legal.privacy','profile.author','profile.player',
'profile.post','ranking.author','ranking.player','review.add','review.index',
...
'validation.custom.attribute-name.rule-name','passwords.password',);
...
'SESSION_LIFETIME','QUEUE_DRIVER','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'MAIL_DRIVER','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER',
'MIX_PUSHER_APP_KEY','MIX_PUSHER_APP_CLUSTER','OSU_CLIENT_ID','OSU_CLIENT_SECRET','REDDIT_CLIENT_ID',
'REDDIT_CLIENT_SECRET','SENTRY_LARAVEL_DSN','SENTRY_TRACES_SAMPLE_RATE','ACKEE_DOMAIN_ID','MOTD_MESSAGE',
'MOTD_TYPE','SAIL_XDEBUG_MODE',);
