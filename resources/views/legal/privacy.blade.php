...
@section('content')
    ...
    c/o IP-Management #24947<br>Andreas Saks<br>Ludwig-Erhard-Str. 18<br>20459 Hamburg



    <p>Phone: 025113396512<br>E-Mail: legal@andrus.io</p>
    ...
    <p>In order to be able to deliver the content of our website quickly, the service uses so-called JavaScript libraries.&nbsp; Corresponding files are loaded from a cdnjs server that records your IP address.&nbsp;</p>
    <p>At</p>
    <p><a href="https://www.cloudflare.com/privacypolicy/" rel="nofollow noopener" target="_blank">https://www.cloudflare.com/privacypolicy/</a>&nbsp;&nbsp;</p>
    <p>Cloudflare offers further data protection information.</p>
    ...
    <p>To totally prevent the execution of cdnjs’ JavaScript code, you can install a so-called JavaScript blocker, such as noscript.net or ghostery.com.&nbsp; If you were to prevent or restrict the execution of the Java Script code, this can mean that for technical reasons not all the content and functions of our website may be available.</p>
    <h4 class="jet-listing-dynamic-field__content">FontAwesome</h4><p>In order to be able to display fonts and visual elements of our website, we use FontAwesome’s external fonts.&nbsp; FontAwesome is a service of</p>
